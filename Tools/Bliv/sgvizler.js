...
// (c) 2011--2013 - Martin G. SkjÃƒÂ¦veland - MIT license
...
(function (window, undefined) { // trick: safekeep 'undefined', and minify.
        ...
        var util = S.util,
            ...
            */
            ...
            sendQuery = function () {
				...
				// Added to Sgvizler by Zakaria Khattabi
				var loader = '<img src="'+document.URL+'/viz/images/icons/ajax-loader.gif" style="margin-top:20%;margin-left:45%;"/>';
				$('#sgVzl').append(loader);
    ...
    S.visualization = (function () {
         ...
         * chart will be drawn.
         * @beta
         * @author Magnus Stuhr, Martin G. SkjÃƒÂ¦veland
         */
                            ...
                            return r.set()
                                ...
                                .push(r.rect(n.point[0],
                                      ...
                                      .attr({fill: color,
									   ...
									   .click(function () { if (URL) { addToMap(namespace.unprefixify(URL)) } })
										   )
                                ...
                                .push(r.text(n.point[0] + n.label.length * opt.nodepadding / 2,
                                      ...
                                      .click(function () { if (URL) { addToMap(namespace.unprefixify(URL)) } })
                                      //.click(function () { if (URL) { document.getElementById('query').value= URL; } })
                                     );
                        };
                    },
                                    ...
                                    "default": new OpenLayers.Style(
                                        {
                                            ...
                                            label : "",
                                            //label : "SPARQL Endpoint with Data Visualization",
                                            fontSize: "10px",
                                            fontFamily: "Arial",
                                            labelAlign: "l",
    ...
    S.datatable = (function () {
         ...
         * discussion above:
         *
         *     EquipmentÃ¢â‚¬Æ’  Location  CountÃ¢â‚¬Æ’
         *     e1          c1        6
         *     e2          c1        2
         *     e3          c1        1
         *     e4          c1        3
