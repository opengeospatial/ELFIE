...
if (!window['google']['loader']) {
    ...
    (function() {
        ...
        function E(a) {
            return a in F ? F[a] : F[a] = -1 != navigator.userAgent[D]()[v](a)
        }
        var F = {};
        ...
        function H(a, b, c) {
            var e = Array[z].slice.call(arguments, 2) || [];
            return function() {
                return a.apply(b, e.concat(Array[z].slice.call(arguments)))
            }
        }
        ...
        function J(a, b) {
            for (var c = a.split(/\./), e = g, f = 0; f < c[y] - 1; f++) e[c[f]] || (e[c[f]] = {}), e = e[c[f]];
            e[c[c[y] - 1]] = b
        }
        ...
        l(google, function(a, b, c) {
            function e(a) {
                var b = a.split(".");
                if (2 < b[y]) throw I("Module: '" + a + "' not found!");
                "undefined" != typeof b[1] && (f = b[0], c.packages = c.packages || [], c.packages[u](b[1]))
            }
            var f = a;
            c = c || {};
            if (a instanceof Array || a && "object" == typeof a && "function" == typeof a[C] && "function" == typeof a.reverse)
                for (var k = 0; k < a[y]; k++) e(a[k]);
            else e(a);
            if (a = N[":" + f]) {
                ...
                c && "string" == typeof c.callback && (k = c.callback, k.match(/^[[\]A-Za-z0-9._]+$/) && (k = g.eval(k), c.callback =
                    k));
                if ((k = c && null != c.callback) && !a.s(b)) throw I("Module: '" + f + "' must be loaded before DOM onLoad!");
        ...
        google.T = function(a, b) {
            b ? (0 == P[y] && (Q(g, "load", R), !E("msie") && !E("safari") && !E("konqueror") && E("mozilla") || g.opera ? g.addEventListener("DOMContentLoaded", R, !1) : E("msie") ? h.write("<script defer onreadystatechange='google.loader.domReady()' src=//:>\x3c/script>") : (E("safari") || E("konqueror")) && g[r](aa, 10)), P[u](a)) : Q(g, "load", a)
        };
        L("google.setOnLoadCallback", google.T);
        ...
        function aa() {
            ca[h.readyState] ? R() : 0 < P[y] && g[r](aa, 10)
        }

        function R() {
            for (var a = 0; a < P[y]; a++) P[a]();
            P.length = 0
        }
        ...
        L("google.loader.rfm", google[A].Q);
        google[A].S = function(a) {
            for (var b in a) "string" == typeof b && b && ":" == b[n](0) && !N[b] && (N[b] = new T(b[B](1), a[b]))
        };
        L("google.loader.rpl", google[A].S);
        google[A].R = function(a) {
            if ((a = a.specs) && a[y])
                for (var b = 0; b < a[y]; ++b) {
                    var c = a[b];
                    "string" == typeof c ? N[":" + c] = new U(c) : (c = new V(c[x], c.baseSpec, c.customSpecs), N[":" + c[x]] = c)
                }
        };
        L("google.loader.rm", google[A].R);
        ...
        google[A].a.B = "//www.google.com/cse/style/look/bubblegum.css";
        M(google[A].a, "BUBBLEGUM", google[A].a.B);
        google[A].a.D = "//www.google.com/cse/style/look/greensky.css";
        M(google[A].a, "GREENSKY", google[A].a.D);
        google[A].a.C = "//www.google.com/cse/style/look/espresso.css";
        M(google[A].a, "ESPRESSO", google[A].a.C);
        google[A].a.G = "//www.google.com/cse/style/look/shiny.css";
        M(google[A].a, "SHINY", google[A].a.G);
        google[A].a.F = "//www.google.com/cse/style/look/minimalist.css";
        M(google[A].a, "MINIMALIST", google[A].a.F);
        google[A].a.H = "//www.google.com/cse/style/look/v2/default.css";
        M(google[A].a, "V2_DEFAULT", google[A].a.H);
        ...
        U[z].g = function(a, b) {
            ...
            if (!this.l) {
                ...
                var e = [],
                    f;
                for (f in this.p) ":" == f[n](0) && e[u](f[B](1));
                for (f in this.i) ":" == f[n](0) && this.i[f] && e[u](f[B](1));
                c += "&have=" + d(e[C](","))
            }
            return google[A][w] + "/?file=" + this.b + "&v=" + a + google[A].AdditionalParams + c
        };
        U[z].v = function(a) {
            var b = null;
            a && (b = a.packages);
            ...
            if (b)
                ...
                for (c = [], a = 0; a < b[y]; a++) "string" == typeof b[a] && c[u](b[a][m](/^\s*|\s*$/, "")[D]());
            c || (c = ["default"]);
            b = [];
            for (a = 0; a < c[y]; a++) this.p[":" + c[a]] || b[u](c[a]);
            return b
        };
        l(U[z], function(a, b) {
            var c = this.v(b),
            ...
            for (var k = [], p = c[y] - 1; 0 <= p; p--) {
                var t = c[p];
                e && f.I(t);
                if (this.i[":" + t]) c.splice(p, 1), e && this.e[":" + t][u](f);
                else k[u](t)
            }
            if (c[y]) {
                b && b.packages && (b.packages = c.sort()[C](","));
                for (p = 0; p < k[y]; p++) t = k[p], this.e[":" + t] = [], e && this.e[":" + t][u](f);
                if (b || null == O[":" + this.b] || null == O[":" + this.b].versions[":" + a] || google[A].AdditionalParams || !this.l) b && b.autoloaded || google[A].d("script", this.g(a, b), e);
                else {
                    c = O[":" + this.b];
                    google[this.b] = google[this.b] || {};
                    for (var S in c.properties) S && ":" == S[n](0) && (google[this.b][S[B](1)] = c.properties[S]);
                    google[A].d("script", google[A][w] + c.path + c.js, e);
                    c.css && google[A].d("css", google[A][w] + c.path + c.css, e)
                }
                this.l && (this.l = !1, this.c = (new Date)[q](), 1 != this.c % 100 && (this.c = -1));
                for (p = 0; p < k[y]; p++) t = k[p], this.i[":" + t] = !0
            }
        });
        U[z].k = function(a) {
            -1 != this.c && (da("al_" + this.b, "jl." + ((new Date)[q]() - this.c), !0), this.c = -1);
            this.q = this.q.concat(a.components);
            google[A][this.b] || (google[A][this.b] = {});
            google[A][this.b].packages = this.q.slice(0);
            for (var b = 0; b < a.components[y]; b++) {
                this.p[":" + a.components[b]] = !0;
                this.i[":" + a.components[b]] = !1;
                var c = this.e[":" + a.components[b]];
                if (c) {
                    for (var e = 0; e < c[y]; e++) c[e].L(a.components[b]);
        ...
        W[z].L = function(a) {
            this.n[":" + a] && (this.n[":" + a] = !1, this.r--, 0 == this.r && g[r](this.K, 0))
        };
        ...
        function V(a, b, c) {
            ...
            this.u = this.h = !1;
            this.j = [];
            google[A].t[this[x]] = H(this.k, this)
        }
        G(V, U);
        l(V[z], function(a, b) {
            var c = b && null != b.callback;
            c ? (this.j[u](b.callback), b.callback = "google.loader.callbacks." + this[x]) : this.h = !0;
        ...
        V[z].k = function() {
            this.u = !0;
            for (var a = 0; a < this.j[y]; a++) g[r](this.j[a], 0);
            this.j = []
        };
        var X = function(a, b) {
        ...
        V[z].g = function(a, b) {
            return this.O(this.w(a), a, b)
        };
        V[z].O = function(a, b, c) {
            var e = "";
            a.key && (e += "&" + X(a.key, google[A].ApiKey));
            a.version && (e += "&" + X(a.version, b));
            b = google[A].Secure && a.ssl ? a.ssl : a.uri;
            if (null != c)
                for (var f in c) a.params[f] ? e += "&" + X(a.params[f], c[f]) : "other_params" == f ? e += "&" + c[f] : "base_domain" == f && (b = "http://" + c[f] + a.uri[B](a.uri[v]("/", 7)));
            google[this[x]] = {}; - 1 == b[v]("?") && e && (e = "?" + e[B](1));
            return b + e
        };
        V[z].s = function(a) {
        ...
        l(T[z], function(a, b) {
            this.h = !0;
            google[A].d("script", this.g(a, b), !1)
        });
        T[z].m = function() {
            return this.h
        };
        ...
        T[z].g = function(a, b) {
            if (!this.f.versions[":" + a]) {
                ...
                if (!this.f.versions[":" + a]) throw I("Module: '" + this.b + "' with version '" + a + "' not found!");
            }
            return google[A].GoogleApisBase + "/libs/" + this.b + "/" + a + "/" + this.f.versions[":" + a][b && b.uncompressed ? "uncompressed" : "compressed"]
        };
        T[z].s = function() {
            return !1
        };
        var ea = !1,
            ...
            fa = (new Date)[q](),
            ha = function() {
                ea || (Q(g, "unload", ga), ea = !0)
            },
            ia = function(a, b) {
                ha();
                if (!(google[A].Secure || google[A].Options && !1 !== google[A].Options.csi)) {
                    for (var c = 0; c < a[y]; c++) a[c] = d(a[c][D]()[m](/[^a-z0-9_.]+/g, "_"));
                    for (c = 0; c < b[y]; c++) b[c] = d(b[c][D]()[m](/[^a-z0-9_.]+/g, "_"));
                    g[r](H(Z, null, "//gg.google.com/csi?s=uds&v=2&action=" + a[C](",") + "&it=" + b[C](",")), 1E4)
                }
            },
            da = function(a, b, c) {
                c ? ia([a], [b]) : (ha(), Y[u]("r" + Y[y] + "=" + d(a + (b ? "|" + b : ""))), g[r](ga, 5 < Y[y] ? 0 : 15E3))
            },
            ga = function() {
                if (Y[y]) {
                    var a =
                        google[A][w];
                    0 == a[v]("http:") && (a = a[m](/^http:/, "https:"));
                    Z(a + "/stats?" + Y[C]("&") + "&nc=" + (new Date)[q]() + "_" + ((new Date)[q]() - fa));
                    Y.length = 0
                }
            },
            Z = function(a) {
    ...
    google.loader.rfm({
        ":search": {
            ...
            "path": "/api/search/1.0/cb6ef4de1f03dde8c26c6d526f8a1f35/",
            "js": "default+fr.I.js",
            "css": "default+fr.css",
            "properties": {
                ":JSHash": "cb6ef4de1f03dde8c26c6d526f8a1f35",
                ":NoOldNames": false,
                ":Version": "1.0"
            }
        },
        ":language": {
            ...
            "path": "/api/language/1.0/ab842e4cebe93c5ab08b2d3db3b8dc59/",
            "js": "default+fr.I.js",
            "properties": {
                ":JSHash": "ab842e4cebe93c5ab08b2d3db3b8dc59",
                ":Version": "1.0"
            }
        },
        ":feeds": {
