setwd("~/Documents/Projects/ELFIE/ELFIE/data/cr/")
library(sf)
...
write.table(can_aquifer_info, file = "nrcan_aquifer_cr.tsv", sep = "\t", row.names = F)
...
write.table(can_hydat_info, file = "nrcan_hydat_cr.tsv", sep = "\t", row.names = F)
...
write.table(can_mon_well_info, file = "nrcan_mon-well_cr.tsv", sep = "\t", row.names = F)
...
write.table(can_watersheds_info, file = "nrcan_watersheds_cr.tsv", sep = "\t", row.names = F)
...
write.table(can_well_info, file = "nrcan_well_cr.tsv", sep = "\t", row.names = F)
