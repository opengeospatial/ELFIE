...
| elf-index | [elf-index.jsonld](https://opengeospatial.github.io/ELFIE/json-ld/elf-all.jsonld) | [xample-elf-index.json](https://opengeospatial.github.io/ELFIE/json-ld/xample-elf-index.json) | Core properties of each feature that support discovery/indexing. Each domain specific JSON file should include these. |
