...
there is no canonical representation of the watershed itself.
...
vulnerable infrastructure and assets published by local jurisdictions as
...
Provided each surface/groundwater features are properly linked together (river
...
demonstrate the usefulness of linked data in the environmental context.
